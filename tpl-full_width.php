...
?>
<?php get_header(); ?>
	<div id="innerLeft" style="width:970px;padding:0;margin:0;">	
		<div class="post">
			...
			<?php /* If there is an attached video in FLV format*/ $key3 = 'videoflv'; $gab_flv = get_post_meta($post->ID, $key3, TRUE); if($gab_flv != '') { ?>
				<p>
					<a href="<?php echo get_post_meta($post->ID, 'videoflv', true); ?>" style="display:block;width:960px;height:380px" id="player1"></a> 
			...
			<?php /* If there is an attached video in SWF format */ $key1 = 'video'; $gab_video = get_post_meta($post->ID, $key1, TRUE); if($gab_video != '') { ?>
				<p>
					<object type="application/x-shockwave-flash" style="width:960px; height:380px;" data="<?php echo get_post_meta($post->ID, 'video', true); ?>">
